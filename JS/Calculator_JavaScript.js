...
const Calculator = {
    ...
    //this will hold the operator, we set it tonull for now
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    // we are checking to see of Wait_Second_Operand is true and set Display_Value to the key that was clicked.
...
// this section handles decimal pionts
function Input_Decimal(dot) {
    // this ensures that accident clicking of the decimal point doesn't cause bugs in your operation.
...
function Handle_Operator(Next_Operator) {
    ...
    //Check if an operator already exists and if Wait_Second_Operand is true, then updates the operator and exits from the function
